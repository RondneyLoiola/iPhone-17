            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="../../public/titanium-design.jpg" alt="iphone-titanium-design" />
                    ...
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="../../public/ios-features.jpg" alt="iphone-features" />
                ...
                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
                    ...
                    <img className="w-full rounded-2xl mb-4" src="../../public/chip-a18-pro.jpg" alt="chip-a18-pro" />
